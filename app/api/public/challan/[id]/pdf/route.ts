...
export async function GET(
    ...
    try {
        ...
        if (!payload || payload.type !== 'challan' || parseInt(payload.targetId) !== challanId) {
        ...
        if (!challan) {
            return new NextResponse('Challan not found', { status: 404 });
        }
        ...
        try {
            ...
            return new NextResponse('Invalid order data in challan', { status: 500 });
        }
        ...
        console.error('Public Challan PDF API Error:', error);
